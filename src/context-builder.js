...
Speak and act ONLY as ${sheetMember}. Do NOT speak for, narrate, or voice the other people in the sheet — they are other participants (other bots / the user). Use the sheet to know who ${sheetMember} is and how they relate to the others.`);
        ...
        const photoInstruction = (mode === 'rp'
            ...
            + ((mode !== 'rp' && voiceNote)
                ? '\n- You can also send a VOICE MEMO: append [VOICE_NOTE: what you say, in ENGLISH] at the very end. The spoken content MUST be English (your voice model is English) even if the chat is Korean — short and natural like a real voice message (1-3 sentences, casual, emotional). Use it when the user wants to hear your voice, when you miss them, for good-morning/good-night, or just occasionally instead of typing. Do NOT overuse (at most once in a while), and always include a normal text reply too.'
                : '');
