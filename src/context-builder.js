...
- ALWAYS write your normal text reply as if there were no memo — full, natural, the message you'd send anyway. NEVER reduce it to an emoji or one word because a memo is attached.
- The memo is something EXTRA on top: a different thought, an aside, something you'd rather say out loud than type. NEVER voice what you already typed — no repeating, no rephrasing the same content.
